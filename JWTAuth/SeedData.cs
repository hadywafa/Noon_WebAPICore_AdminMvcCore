        ...
        public async Task HwAddProducts()
        {
            ...
            if (!isInserted)
            {
                var pro1 = new Product()
                {
                    ...
                    Description = "Experience the joy of Samsung's LED picture quality for enhanced contrast and quicker response times.",
                ...
                var pro2 = new Product()
                {
                    ...
                    Description = "Amplified display: A brilliant FHD panel (220 nits) offers more brightness and vivid color for an enhanced front-of-screen experience, and a 2-sided narrow border emphasizes your screen while helping minimize distractions.",
                    DescriptionArabic = "شاشة كبيرة: يتميز بشاشة رائعة بدقة كاملة الوضوح وسطوع 220 شمعة لتوفير المزيد من السطوع والألوان الزاهية لتجربة مشاهدة رائعة من أمام الشاشة، وتتميز بحواف رفيعة على الجانبين مما يمنحها مظهراً مميزاً ويساعد على تقليل التشتت",
                ...
                var pro3 = new Product()
                {
                    ...
                    NameArabic = "جهاز تشغيل العاب الفيديو الرقمية بلاي ستيشن 5 (إصدار الأقراص) مع وحدة تحكم لاسلكية إضافية",
                    ...
                    DescriptionArabic = "منتج يتميز بسرعة عالية - استغل قوة وحدة المعالجة المركزية المخصصة وبطاقة الرسومات ومحرك الأقراص SSD مع وحدات الإدخال والإخراج المدمجة التي تعمل على إعادة كتابة القواعد التي يمكن لجهاز الألعاب بلايستيشن فعلها.",
                ...
                var pro4 = new Product()
                {
                    ...
                    Description = "The ultimate iPad experience Now with breakthrough M performance, a breathtaking XDR display, and blazing‑fast 5G wireless Buckle up",
                    DescriptionArabic = "استمتع بأفضل تجربة مع آي باد بفضل الأداء الثوري للمعالج ، وشاشة متطورة تعمل بتقنية ، واتصال لاسلكي عالي السرعة بتقنية 5",
                ...
                var pro5 = new Product()
                {
                    ...
                    Description = "Big screen. Huge impact. The larger display enhances the entire experience, making Apple Watch easier to use and read. Series 7 represents our biggest and brightest thinking yet. The challenge was to create a bigger display while barely expanding the dimensions of the watch itself.",
                    DescriptionArabic = "مزودة بشاشة كبيرة تتميز بمقاومة عالية للصدمات تتميز ساعة أبل بشاشة كبيرة لتحسين تجربة الاستخدام وسهولة القراءة تمثل ساعة سيريس 7 أكبر وأفضل أفكارنا حتى الآن كان التحدي هو الحصول على شاشة عرض أكبر",
                ...
                var pro6 = new Product()
                {
                    ...
                    Description = "Lightning Speed - Harness the power of a custom CPU, GPU, and SSD with Integrated I/O that rewrite the rules of what a PlayStation console can do.",
                    DescriptionArabic = "منتج يتميز بسرعة عالية - استغل قوة وحدة المعالجة المركزية المخصصة وبطاقة الرسومات ومحرك الأقراص مع وحدات الإدخال والإخراج المدمجة التي تعمل على إعادة كتابة القواعد التي يمكن لجهاز الألعاب بلايستيشن فعلها.",
                    Category = await _catRepo.Find(c => c.Code == "video-games"),
                    BuyingPrice = 20000,
                    SellingPrice = 50000,
                    Revenue = 50000 - 20000,
                ...
                var pro7 = new Product()
                {
                    ...
                    DescriptionArabic = "كاميرا احترافية بدقة 108 ميجابكسل | عدسة ماكرو وعدسة وواسعة للغاية",
                    Category = await _catRepo.Find(c => c.Code == "electronics-and-mobiles"),
                    BuyingPrice = 8500,
                    SellingPrice = 9999,
                    Revenue = 30000 - 25000,
